        ...
        <div class="d-flex justify-content-end">
            ...
            <div class="container-fluid table-responsive">
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #d7d2cc;">
                  <div>
                    ...
                    <a href="#" style="font-weight: bold; font-size:22px">Table des Publications </a>
            ...
            <div class="container-fluid">
                <table id="t1" class="table table-bordered display nowrap" cellspacing="0" width="100%">
                 ...
                 <thead>
                    <tr>
                       <th>Centre de décision</th>
                       <th>Total publication</th>
                       <th>Prorogation</th>
                       <th>Avis de lancement</th>
                       <th>Avis de Préqualification</th>
                        <th>Résultat Préqualification</th>
                       <th>Attribution des marchés</th>
                       <th>Réctificatif</th>
                       <th>Avis annulation</th>
                    </tr>
                 </thead>
...
'columnDefs': [
      ...
      'columns': [ 
         ...
         { 'data': "Résultat Préqualification"},
