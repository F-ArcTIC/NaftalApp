...
<nav id="sidebar" style="background: #d7d2cc;  /* fallback for old browsers */
        ...
        ">
            ...
            <div class="sidebar-header">
                <a href="../Acceuil.php"><img src="../../photo/1200px-LogoNAFTAL.svg.png" style="height: 70px; background-size: contain!important;position: relative;  z-index: auto !important; width: 160px;"></a>
                <h3></h3>
                </div>
                    ...
                    <ul class="list-unstyled components" id="sidecomp">
                         ...
                         <br>
                        <li id="dPub">
                            <a href="pages/odification.php">Demandes de Codifications</a>
                        </li>
                        <li class="" id="Acceuil">
                            <a href="pages/Décisioncvt.php">Décision CVT</a>
                        </li>
                        <li class="" id="Acceuil">
                            <a href="pages/codification.php"><i class="fas fa-home"></i>  Acceil</a>
                        </li>
                        <li class="" id="Acceuil">
                            <a href="pages/codification.php"><i class="fas fa-home"></i>  Acceil</a>
                        </li>
            ...
            ">
                <div class="container-fluid row ">
                        ...
                        <div class="col" >
                            <a href="../Acceuil.php"><img src="../../photo/1200px-LogoNAFTAL.svg.png" style="height: 55px; background-size: contain!important;position: relative;  z-index: auto !important; width: 140px;"></a>
                        </div>
