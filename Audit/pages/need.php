  ...
  <div class="container-fluid table-responsive">
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #d7d2cc;">
                   ...
                   <div></div>
                    ...
                    <a href="#" style="font-weight: bold; font-size:22px">Table des Commissions ADHOC</a>
                ...
                <div class="container-fluid row card-header d-flex justify-content-between align-items-center" >
                  <div class=" col-sm-4 col-md-4 col-xs-12 row" >
