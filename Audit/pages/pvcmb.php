                                        ...
                                        <div class="row"> 
                                          <div class="col-sm-12 col-md-12 col-xs-12">
                                                            <div class="custom-control custom-checkbox">
                                                                  ...
                                                                  <label class="custom-control-label" for="cmbacc">VISA Accordée</label>
                                            ...
                                            <div class="col-sm-6 col-md-6 col-xs-12">  
                                                <div class="form-group">   
                                                    ...
                                                    <select class="form-control" id="typevisa">
                                                        ...
                                                        <option value="Lancement de pré-qualification">Lancement de pré-qualification</option>
                                                        <option value="Recours au gré a gré">Recours au gré a gré</option>
                                        ...
                                        <div class="row"> 
                                          <div class="col-sm-12 col-md-12 col-xs-12">
                                                            <div class="custom-control custom-checkbox">
                                                                  ...
                                                                  <label class="custom-control-label" for="mcmbacc">VISA Accordée</label>
...
function rowselected () {
    ...
    var res=[el.data().id_pv, el.data().num_pv,el.data().date_pv,el.data().n_date, el.data().code, el.data().objet, el.data().accord,el.data().num_visa, el.data().file_pv,el.data().type_visa,];
...
$('#mpvcmb ').on('change',function(){
                //get the file name
                var fileName = $(this).val();
                //replace the "Choose a file" label
                $(this).next('#mfilepvcmb').html(fileName);
            });
                   ...
                   if ($("#cmbacc").is(":checked")== true) 
                    ...
                    var typevisa = $("#typevisa").val();
                        ...
                        $.post("PHP/add_pvcmb.php",
                            {code:Code, numpv:numpv, datepv:datepv, file_pv:data.pvcmb, accord:cmbacc, num_visa:numvisa, typevisa:typevisa   },
                   ...
                   if ($("#mcmbacc").is(":checked")== true) 
                    ...
                    var numvisa = $("#mnumvisa").val();
                        ...
                        $.post("PHP/edit_pvcmb.php",
                            {id_cmb:id_cmb, ancode:ancode, code:Code, num_pv:numpv, typevisa:typevisa, date_pv:datepv, file_pv:data.pvcmb, an_pv:res[8], accord :cmbacc, num_visa:numvisa  },
