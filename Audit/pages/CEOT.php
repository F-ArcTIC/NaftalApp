  ...
  <div class="container-fluid table-responsive">
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #d7d2cc;">
                   ...
                   <div></div>
                    ...
                    <a href="#" style="font-weight: bold; font-size:22px">Table des Commissions CEOT</a>
                        ...
                        <div class="modal-content">
                            <div style="background: #8e9eab;  /* fallback for old browsers */
                                ...
                                <div class="modal-header text-center">
                                    <h4 class="modal-title w-100 font-weight-bold">Nouvelle Commission CEOT ...</h4>
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div style="background: #8e9eab;  /* fallback for old browsers */
                                ...
                                background: linear-gradient(to right, #eef2f3, #8e9eab);">
                                <div class="modal-header text-center">
                                    <h4 class="modal-title w-100 font-weight-bold">Modifier Commission CEOT ...</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
...
$('#type').change(function(){
 ...
 element = document.getElementById("Commissions");
  ...
  element = document.getElementById("CEOT");
  element.classList.toggle("active2");
  });
 ...
 var table=$('#t1').DataTable();
  ...
  $('#buttonAdd').click( function () {
    $('#Code').selectpicker();
                ...
                $.post("PHP/get_code_com_ceot.php",
                        {type:type},
                        ...
                        $.post("PHP/add_ceot.php",
                            ...
                            function(data,status){
                                ...
                                $('#numD').val('');
                                    ...
                                    $.toast({
                                heading: 'Success',
                                text: 'Commmission CEOT bien Ajouté',
...
*/
                                    ...
                                    $.toast({
                                heading: 'Error',
                                text: 'Commmission CEOT Non Ajouté',
                        ...
                        $.post("PHP/edit_cvt.php",
                            ...
                            function(data,status){
                                ...
                                $('#t1').DataTable().ajax.reload();
                                    ...
                                    $.toast({
                                heading: 'Success',
                                text: 'Commmission CEOT bien Modifié',
                                showHideTransition: 'slide',
                                hideAfter: 5000,
                                position: 'top-right',
                                icon: 'success'
...
*/
                                    ...
                                    $.toast({
                                heading: 'Error',
                                text: 'Commmission CEOT Non Modifié',
                                showHideTransition: 'plain',
                                hideAfter: 5000,
                                position: 'top-right',
                                icon: 'error'
