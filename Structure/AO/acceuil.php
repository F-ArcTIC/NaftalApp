        ...
        <div id="content">
            ...
            ">
                <div class="container-fluid row">
                        ...
                        <div class="col" >
                            <a href=""><img src="../../css/1200px-LogoNAFTAL.svg.png" style="height: 55px; background-size: contain!important;position: relative;  z-index: auto !important; width: 140px;"></a>
                        </div>
                        <div class="dropdown">
             ...
             <section class="content">
                <nav class="menu menu--salal">
                    <a class="menu__item" href="datatable.html">
                        <span class="menu__item-name"></span>
                    </a>
                    <a class="menu__item" href="codification.php">
                        <span class="menu__item-name">Codification des Projet</span>
                    </a>
                    <a class="menu__item" href="index.php">
                        <span class="menu__item-name">Appel d'Offre</span>
                    </a>
