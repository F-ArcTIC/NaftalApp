        ...
        $('#lu').on('change',function(){
            ...
            function(data,status){
                                ...
                                for(x=0;x<data.nb;x++) {
                                    ...
                                    if($contenu=='Nouvelle Demande de Codification'){
                                    ...
                                    if($contenu=='Mot de passe oublié'){
                                    html+='<section class="daily-activities"><header class="date-header">'+$date+'</header><ul class="activities"><li ><i ></i><p class="contents"><strong>'+$expediteur+': </strong>'+$contenu+'.<span class="acted-time"> '+$heure+'</span></p></li><a href="mailto:'+$email+'" class="parmail">E-mail : '+$email+' </a></ul></section>';
                                    }
                                }
