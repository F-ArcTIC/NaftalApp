...
function rowselected () {
    ...
    var res=[el.data().id_pv, el.data().num_pv,el.data().date_pv,el.data().n_date, el.data().code, el.data().objet, el.data().Recommandation,el.data().num_visa, el.data().file_pv];
  ...
  element = document.getElementById("PVCEOT");
  element.classList.toggle("active2");
  });
            ...
            success: function(data)
            {
               ...
               if(data.success){
                   ...
                   var datepv = $("#datepv").val();
                        ...
                        $.post("PHP/addpvceot.php",
                            {code:Code, numpv:numpv, datepv:datepv, file_pv:data.pvceot },
               ...
               if(data.success){
                ...
                var ancode = res[4];
                   ...
                   var datepv = $("#mdatepv").val();
                        //alert(code +"   "+ declencheur+ "   "+type+"   "+mode+"  "+objet+ "   "+pdao+"   "+Fiche_s+"  "+Projet_c );
                        $.post("PHP/edit_pvceot.php",
                            {ancode:ancode, id_ceot:id_ceot, code:Code, num_pv:numpv, date_pv:datepv, file_pv:data.pvceot, an_pv:res[8], },
                            ...
                            function(data,status){
                                ...
                                $("#mpvceot").next('#filepdao').html("Choisissez un fichier");
                                    
                                    $.toast({
                                heading: 'Error',
                                text: 'PV CEOT Non Modifié',
                                showHideTransition: 'plain',
                                hideAfter: 5000,
                                position: 'top-right',
                                icon: 'error'
