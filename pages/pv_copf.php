  ...
  <div class="container-fluid table-responsive">
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #d7d2cc;">
                   ...
                   <div></div>
                    ...
                    <a href="#" style="font-weight: bold; font-size:22px">Table des PVs d'ouverture financière</a>
                        ...
                        <div class="modal-content">
                            <div style="background: #8e9eab;  /* fallback for old browsers */
                                ...
                                <div class="modal-header text-center">
                                    <h4 class="modal-title w-100 font-weight-bold">Nouveau PV financier ...</h4>
...
function rowselected () {
    ...
    var res=[el.data().id_pv, el.data().num_pv,el.data().date_pv,el.data().n_date, el.data().code, el.data().objet,el.data().file_pv];
...
//TODO add some select...options column as example
  ...
  element = document.getElementById("PVCOPf");
  element.classList.toggle("active2");
  });
  loadData();
                        ...
                        function(data,status){
                          if(data.success){
                            ...
                            var l=data.data.length;
                                ...
                                for(x=0;x<l;x++) {
                                  if(data.data[x].code==res[4]) html+='<option value="'+data.data[x].code+' selected ">'+data.data[x].code+'</option>';
                                   else html+='<option value="'+data.data[x].code+'">'+data.data[x].code+'</option>';
                                }
                   ...
                   var nboff = $("#mnboff").val();
                        ...
                        $.post("PHP/edit_pvcopf.php",
                            ...
                            function(data,status){
                                ...
                                $("#mpvcopt").next('#filepdao').html("Choisissez un fichier");
