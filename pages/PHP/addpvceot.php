...
$sql ="INSERT INTO `pv_evaluation` (`id_pv`, `num_pv`, `date_pv`, `file_pv`, `code`) VALUES (NULL, '";//15', '2019-05-08', 'a.com', '0', NULL, 'world')";
$query="UPDATE `appel_doffre` SET `etape` = 'CEOT' WHERE `code` = '";
