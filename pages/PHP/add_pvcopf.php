...
$sql ="INSERT INTO `pv_fin` (`id_pv`, `num_pv`, `date_pv`, `file_pv`, `code`) VALUES (NULL, '";//15', '2019-05-08', 'a.com', '0', NULL, 'world')";
$query="UPDATE `appel_doffre` SET `etape` = 'COP financier'"; 
			...
			{	$file_pv=$_POST["file_pv"];
					...
					{	$code=$_POST["code"];
						if($conn->query($sql.$num_pv."','".$date_pv."','".$file_pv."','".$code."')")===TRUE)
							...
							if ($conn->query($query." where  `code`='".$_POST["code"]."'") === FALSE) 
						                {
						                    $reply["success"]=FALSE;
