		     ...
		     if(in_array($extension, $allowed_extension))
		    	{
				  ...
				  if(move_uploaded_file($sourcePath,$targetPath)) 
					...
					{	$reply["success"]=FALSE;
		                 $reply["message"]='PV financier Non chargé !'."\r\n";
				...
				{
					$reply["success"]=FALSE;
		           $reply["message"]='Extension du fichier PV financier Non valide, Veuillez ajouter un pdf !!'."\r\n"."\r\n";
		        }
	}else
{
 $reply["success"]=FALSE;
 $reply["message"]="PV financier Non inseré !";
}
}
else
{
