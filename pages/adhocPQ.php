...
<body>
  ...
  <div class="container-fluid table-responsive">
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #d7d2cc;">
                   ...
                   <div></div>
                    ...
                    <a href="#" style="font-weight: bold; font-size:22px">Table des Commissions ADHOC PQ</a>
                        ...
                        <div class="modal-content">
                            <div style="background: #8e9eab;  /* fallback for old browsers */
                                ...
                                <div class="modal-header text-center">
                                    <h4 class="modal-title w-100 font-weight-bold">Nouvelle Commission ADHOC PQ ...</h4>
                                ...
                                <div class="modal-body mx-3">
                                    <form id="formAdd" method="post">    
                                        ...
                                        <div class="modal-footer d-flex justify-content-center">
                                            ...
                                            <button class="btn btn-primary rounded-0"  type="button" id="test">Test compatibilité </button>
                                        </div>
                                    </form>
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div style="background: #8e9eab;  /* fallback for old browsers */
                                ...
                                background: linear-gradient(to right, #eef2f3, #8e9eab);">
                                <div class="modal-header text-center">
                                    <h4 class="modal-title w-100 font-weight-bold">Modifier Commission ADHOC PQ ...</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                ...
                                <div class="modal-body mx-3">
                                    <form id="formEdit" method="post">    
                                        ...
                                        <div class="modal-footer d-flex justify-content-center">
                                            ...
                                            <button class="btn btn-primary rounded-0"  type="button" id="mtest">Test compatibilité </button>
  ...
  element = document.getElementById("adhoc");
  element.classList.toggle("active2");
  });
                        ...
                        $.post("PHP/add_cvt.php",
                            ...
                            function(data,status){
                                ...
                                $('#numD').val('');
                                    ...
                                    $.toast({
                                heading: 'Success',
                                text: 'Commmission ADHOC PQ bien Ajouté',
...
*/
                                    ...
                                    $.toast({
                                heading: 'Error',
                                text: 'Commmission ADHOC PQ Non Ajouté',
                        ...
                        $.post("PHP/edit_cvt.php",
                            ...
                            function(data,status){
                                ...
                                $('#t1').DataTable().ajax.reload();
                                    ...
                                    $.toast({
                                heading: 'Success',
                                text: 'Commmission ADHOC PQ bien Modifié',
                                showHideTransition: 'slide',
                                hideAfter: 5000,
                                position: 'top-right',
                                icon: 'success'
...
*/
                                    ...
                                    $.toast({
                                heading: 'Error',
                                text: 'Commmission ADHOC PQ Non Modifié',
                                showHideTransition: 'plain',
                                hideAfter: 5000,
                                position: 'top-right',
                                icon: 'error'
   ...
   $('#mtest').click( function () {  var Membresarray = $("#mMembres").val();
var type = $("#type").val();
                   var code = $("#mCode").val();
                    var President = $("#mPresident").val();
                    var Juriste = $("#mJuriste").val();
                    var Financier = $("#mFinancier").val();
                      Membresarray.push(President);
                        Membresarray.push(Juriste);
                        Membresarray.push(Financier); 
                       
               //alert(data.message);

         $.post("PHP/compatible_membre.php",
                            {Membres:Membresarray, type:type, code:code},      
              function(data,status){
                if(data.compatible==0)    alert(data.message);
                                else  alert("Membres compatible");
   ...
   $('#test').click( function () {  var Membresarray = $("#Membres").val();
var type = $("#type").val();
                   var code = $("#Code").val();
                    var President = $("#President").val();
                    var Juriste = $("#Juriste").val();
